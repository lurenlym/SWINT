...
parser.add_argument('--rawpicroot', type=str, default='C:\\Users\\lyming\\Desktop\\SFCdata\\re\\')
...
train_data=MyData_Autoencoder.MyDataset(maskroot=args.maskpicroot,rawroot=args.rawpicroot,datatxt='relists.txt', transform=None)
...
def test():
    fh = open('jingguanglists.txt', 'r')  # 按照传入的路径和txt文本参数，打开这个文本，并读取内容
